...
import (
	...
	shapes2 "retardation/draw_control/shapes"
	h "retardation/help"
...
func loadMomentum(euler *eu.Euler) {
	planet1, planet2 := euler.GetPlanets()
	initMomentum = &Momentum{
		Vx: (planet1.Mass*planet1.VelocityX + planet2.Mass*planet2.VelocityX) / (planet1.Mass + planet2.Mass),
		Vy: (planet1.Mass*planet1.VelocityY + planet2.Mass*planet2.VelocityY) / (planet1.Mass + planet2.Mass),
		X:  (planet1.Mass*planet1.PositionX + planet2.Mass*planet2.PositionX) / (planet1.Mass + planet2.Mass),
		Y:  (planet1.Mass*planet1.PositionY + planet2.Mass*planet2.PositionY) / (planet1.Mass + planet2.Mass),
	}
